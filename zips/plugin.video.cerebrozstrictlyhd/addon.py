...
if not params:
    ...
    list_item = xbmcgui.ListItem(label='[COLOR red]* [/COLOR]Popular')
    ...
    list_item = xbmcgui.ListItem(label='[COLOR red]* [/COLOR]Trending')
    list_item.setArt({'thumb':trending,'fanart':fanart,'poster':trending})
    ...
    list_item = xbmcgui.ListItem(label='[COLOR red]* [/COLOR]Search')
